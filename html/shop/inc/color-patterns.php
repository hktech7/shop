 ...
 */
function shop_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Shop default saturation level.
	 *
	 * @since Shop 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'shop_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.shop-front-page) .entry-title,
...
.colors-custom .shop-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.shop-front-page .panel-content .recent-posts article,
...
.colors-custom.shop-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'shop_custom_colors_css', $css, $hue, $saturation );
}
